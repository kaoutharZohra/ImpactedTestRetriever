...
public class JavaVisitor extends ASTVisitor {//abstract?
	...
	public boolean visit(SimpleName node) {//TODO if the binding treatment is needed elsewhere, then extract it in a new method
		...
		if(binding == null) {
			...
			if(binding.getKey().equals("Lorg/eclipse/modisco/infra/discovery/benchmark/impl/DiscoveryIterationImpl;.getDiscoveryErrors()Ljava/lang/String;"))
			{
				System.out.println(" you visit the wanted binding here");
			}
		//	if(!JavaParser.isPrimitiveType(binding)){
				...
				if(manageBindings.getBindingsNodes().containsKey(binding)){
					...
					if(binding.getKey().equals("Lorg/eclipse/modisco/infra/discovery/benchmark/impl/DiscoveryIterationImpl;.getDiscoveryErrors()Ljava/lang/String;"))
					{
						System.out.println(" you add later the wanted binding here");
					}
					...
					if(binding.getKey().equals("Lorg/eclipse/modisco/infra/discovery/benchmark/impl/DiscoveryIterationImpl;.getDiscoveryErrors()Ljava/lang/String;"))
					{
						System.out.println(" you add second the wanted binding here");
					}
...
//			}
//			else {
//				if(binding.getKey().contains("validateSafeIteratorIsRequired"))
//				{
//					System.out.println(" validateSafeIteratorIsRequired nodes "+node+ " its binding "+node.resolveBinding().getKey()+ " starts at  "+node.getStartPosition());
//				}
//			}
				if(binding.getKey().contains("validateSafeIteratorIsRequired"))
				{
